...
java -jar distance-cache-util-jar-with-dependencies.jar export --resolution 7 ../../../data/metro-manila-geojson.json -o ../../../data/metro-manila-res7.distcache
```
...
```zsh
java -jar distance-cache-util-jar-with-dependencies.jar import ../../../data/metro-manila-res7.distcache 
```
